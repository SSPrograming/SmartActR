...
class InstructionService:
    ...
    def get_all_instrucion():
        ...
        for i in instructionObject_list:
            ...
            TagList = InstructionTag.query.filter(
                InstructionTag.instructionID == i.instructionID).all()
            for tag in TagList:
    ...
    def getTagList():
        taglist_raw = InstructionTag.query.with_entities(
            InstructionTag.tagName).filter().all()
